...
- publication: [ GPCRmd uncovers the dynamics of the 3D-GPCRome](https://www.nature.com/articles/s41592-020-0884-y), Nat Methods, 2020.
...
The GPCRmd API does not provide any endpoint to access file-level metadata. All file information is extracted from the dataset web page.
...
For example, the files corresponding to the dataset `12` (https://www.gpcrmd.org/dynadb/dynamics/id/12/) include these files:
